    ...
    <html lang="en">
      ...
      <body>
        <main>
          ...
          {children}
          <footer className="relative bg-eerieBlack pt-16 pb-32 text-white">
            ...
            <div className="container mx-auto px-5">
              ...
              <div className="grid grid-flow-col grid-rows-2 gap-3 py-16 text-[9px] font-medium leading-3">
                <div>
              ...
              <p className="text-center text-xs font-normal leading-4">
                ©️2022 Hexabase
              </p>
            </div>
          </footer>
