      ...
      <body>
        ...
        {showMenu ? (
          ...
          <>
            ...
            <footer className={logged ? "relative bg-eerieBlack pt-16 pb-6 sm:pb-5 text-white sm:pb-1 sm:pt-12" : "relative bg-eerieBlack pt-16 pb-32 text-white sm:pb-1 sm:pt-12"}>
