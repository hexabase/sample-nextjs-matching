  ...
  return (
    <div className='grid gap-9'>
        ...
        >
          {({
            ...
            >
              <div className='grid gap-6 lg:gap-7'>
                <div>
                  <div className="text-left">
                    <label className="text-sm font-bold">会社名</label>
                ...
                <div>
                  <div className="text-left">
                    <label className="text-sm font-bold">事業内容</label>
                    <span className="text-xs font-bold text-red">（必須）</span>
                  </div>
                  <div className="relative flex w-full flex-row">
                    <textarea
                      ...
                      onChange={handleChange}
                      onBlur={handleBlur}
                      className={`${touched.businessDetail && errors.businessDetail
                        ? 'border-red'
                        : 'border-argent  hover:border-aquamarine  '
                ...
                <div>
                  <div className="text-left">
                    <label className="text-sm font-bold">企業ホームページURL</label>
                  </div>
                  <div className="relative flex w-full flex-row">
                    <input
                      type="url"
              ...
              <div className="py-11 text-left text-sm font-normal lg:mx-auto">
                <p>「ログイン」ボタンを押すことで、</p>
                <p>
      ...
      <div className="flex flex-col items-center justify-center rounded-3xl bg-white px-8 py-12 shadow-lg">
        <div className="pb-10 px-6 text-center font-bold lg:flex lg:flex-row">
